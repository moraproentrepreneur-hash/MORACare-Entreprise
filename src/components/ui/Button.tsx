...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-mora-blue hover:bg-mora-navy text-white focus:ring-mora-blue shadow-md hover:shadow-lg',
      secondary: 'bg-mora-green hover:bg-emerald-600 text-white focus:ring-mora-green shadow-md',
