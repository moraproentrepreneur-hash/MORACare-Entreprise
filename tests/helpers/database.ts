...
/**
 * Simulation de Supabase, partagée avec les scripts de validation.
 *
 * Le fichier SQL est la source unique : trois copies coexistaient, et elles
 * ont fini par diverger.
 */
const SUPABASE_STUB = fs.readFileSync(
  path.join(process.cwd(), 'supabase', 'testing', 'supabase-stub.sql'),
  'utf8',
);
